...
router.get('/authorization/me', checkAuth, validation.loginValidation, handleValidationErrors, userController.authorizationMeUser);//where is more add checkAuth? And handleValidationErrors needs here?
